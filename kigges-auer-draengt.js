...
// @description    Macht den Running-Gag Link zum bekannten Kicker Artikel "Auer draengt, Klopp bremst" Link als solchen sichtbar^^
...
(function() {
  ...
  for( i = 0; i < dim ; i += 1 ) {
    ...
    if(
        ...
        || currentLink === 'http://www.tinyurl.com/kigges'
       ) {
